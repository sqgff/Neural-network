...
class RBM(object):
    def __init__(self, name="rbm",
        ...
        """
        # Model configuration, to be specified by users
        ...
        # Tensorflow placehoders, for input dataset
    ...
    def sample_v_given_h(self, h0_sample):
        ...
        if self.visible_unit_type == 'binary':
            ...
            return tf.truncated_normal((1, self.n_visible),
                    mean=visible_activation, stddev=self.stddev)
